<template>
	<view class="content">
		<view class="catelist">
		<navigator :url="'goodList/goodList?id='+item.id" class="item" v-for="item in categoryList" :key="item.id">
...
<script>
	import {findCategory} from '../../api/category/index.js'
	export default {
		data() {
			return {
				categoryList:''
...
<style lang="scss" scoped>
  ...
  .catelist{
	  ...
	  .item:nth-child(2),.item:nth-child(){
